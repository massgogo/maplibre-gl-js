...
import {LayerBackground, LayerCircle, LayerFill, LayerLine, LayerSymbol, LayerSymbolWithIcons, LayerTextWithVariableAnchor, LayerSymbolWithSortKey} from '../benchmarks/layers';
